...
![Figma mockup](assets/initial-mockup/figma_mockup.gif)
...
#### Partner Approval
![approval](assets/initial-mockup/user_story_confirmation.png)
...
![Alt text](assets/initial-mockup/q6_1.png "Some fun team facts")


The following meeting, we took some time to play a few discord games together:
![Alt text](assets/initial-mockup/q6_2.png "A game we played together")
...
![D1_Q12](assets/initial-mockup/D1_Q12.png)
